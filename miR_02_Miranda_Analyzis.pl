...
my %OptionsHelp = (
		    'Miranda results' => '-r [file], miranda filtered resuls',
...
#-------------------------------------------------------------------------------
GetOptions(%Options);
defined $file_result || &usage('Miranda results file (-r) required');
...
my $nameOUTPUT = $file_result."_PROCESSED";
open (OUT, ">$nameOUTPUT") or die 'cannot create output file!';
...
print "Results written to file: $nameOUTPUT\n";
